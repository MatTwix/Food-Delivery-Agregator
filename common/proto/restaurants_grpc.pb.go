...
func (c *restaurantServiceClient) GetMenuItems(ctx context.Context, in *GetMenuItemsRequest, opts ...grpc.CallOption) (*GetMenuItemsResponse, error) {
	out := new(GetMenuItemsResponse)
	err := c.cc.Invoke(ctx, "/restaurants.RestaurantService/GetMenuItems", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedRestaurantServiceServer) GetMenuItems(context.Context, *GetMenuItemsRequest) (*GetMenuItemsResponse, error) {
...
func _RestaurantService_GetMenuItems_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetMenuItemsRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(RestaurantServiceServer).GetMenuItems(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/restaurants.RestaurantService/GetMenuItems",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(RestaurantServiceServer).GetMenuItems(ctx, req.(*GetMenuItemsRequest))
	}
	...
	Methods: []grpc.MethodDesc{
		{
			...
			Handler:    _RestaurantService_GetMenuItems_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "common/proto/restaurants.proto",
}
